...
class RegistroPlantao {
    ...
    async salvarRegistro() {
        try {
            ...
            const registro = {
                ...
                uid: window.auth.currentUser.uid, // Adicionar UID do usuário
                data: dados.data,
    ...
    async carregarRegistros() {
        try {
            ...
            // Mostrar mensagem de sucesso se houver registros
            if (this.registros.length > 0) {
                this.mostrarInfo(`${this.registros.length} registros carregados com sucesso`);
            }
