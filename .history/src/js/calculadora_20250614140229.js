...
class Calculadora {
    ...
    calcularValorRegistro(registro, valorHora) {
        try {
            if (!registro || !valorHora) {
                throw new Error('Registro e valor da hora são obrigatórios');
            }
            ...
            const valorHoraCalculado = this.calcularValorHora(valorHora, temBonus, ehFeriado);
