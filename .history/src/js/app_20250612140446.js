import { GerenciadorFirestore } from './storage.js';
...
class BancoHorasApp {
    constructor(uid) {
        ...
        this.storage = new GerenciadorFirestore();
    ...
    async carregarDados() {
        try {
            this.registros = await this.storage.carregarRegistros(this.uid);
    ...
    async adicionarRegistro(registro) {
        await this.storage.adicionarRegistro(this.uid, registro);
        await this.carregarDados();
    ...
    async atualizarRegistro(registro) {
        await this.storage.atualizarRegistro(this.uid, registro.id, registro);
        await this.carregarDados();
        this.registroEditando = null;
